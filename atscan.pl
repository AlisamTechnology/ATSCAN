...
## EXTERN COMMAND
sub mcommand { 
  makeSscan("", "", "3", "", "", \@TODO, \@V_TODO, $SCAN_TITLE[16], "", "", "", "", $command, ""); stak(); adios(); exit();
}
############################################################################################################################################################################################
############################################################################################################################################################################################
## MD5 ENCODE
sub mmd5 {
  scanCode($SCAN_TITLE[17], $mmd5, "1", "", ""); adios();
} 
############################################################################################################################################################################################
############################################################################################################################################################################################
## ENCODE BASE 64
sub mencode64 {
  scanCode($SCAN_TITLE[18], $mencode64, "", "1", ""); adios();
}
############################################################################################################################################################################################
############################################################################################################################################################################################
## DECODE BASE 64
sub mdecode64 {
  scanCode($SCAN_TITLE[19], $mdecode64, "", "", "1"); adios();
}
############################################################################################################################################################################################
############################################################################################################################################################################################
## PRINT DESCLAIMER
if ((!defined $dork) && (!defined $help) && (!defined $Target) && (!defined $mmd5) && (!defined $mencode64) && (!defined $checkVersion) && (!defined $mdecode64)) { advise(); }
osinfo();
############################################################################################################################################################################################
############################################################################################################################################################################################
