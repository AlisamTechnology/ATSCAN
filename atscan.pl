...
for my $ADMINARGS(@ADMINARGS) {
  if ($ADMINARGS=~/MYEXT/) {
    $ADMINARGS=~s/MYEXT/php/; push @ADMIN, $ADMINARGS;
    $ADMINARGS=~s/php/html/; push @ADMIN, $ADMINARGS;
    $ADMINARGS=~s/html/asp/; push @ADMIN, $ADMINARGS;
