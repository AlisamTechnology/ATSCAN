...
############################################################################################################################################################################################
## XSS
my @XSS = ("%27", "1%27", "'><script>alert('MySQL Error')</script>", "<scr<script>ipt>alert(/MySQL Error/)</scr</script>ipt>", "%253script%253ealert(/MySQL Error/)%253c/script%253e");
############################################################################################################################################################################################
############################################################################################################################################################################################
## RFI
...
## XSS
sub xss { 
  makeSscan("", "", "3", "", "", \@XSS, \@V_XSS, $SCAN_TITLE[5], $paylNote, "", "", "", "", "1"); 
