...
######################################################################################################################################################################################################
######################################################################################################################################################################################################
our $outdir ="$Bin/output";
######################################################################################################################################################################################################
######################################################################################################################################################################################################
our ($Version, $logoVersion, $scriptUrl, $logUrl, $ipUrl, $conectUrl, $script, $script_bac, $scriptbash, $scriptPass, $searchRegex, $regex, $validText, $scriptv);
$Version="11.4";
...
######################################################################################################################################################################################################
######################################################################################################################################################################################################
our ($WpSites, $JoomSites, $xss, $lfi, $JoomRfi, $WpAfd, $adminPage, $subdomain, $mupload, $mzip, $searchIps, $eMailS, $port, $data, $command);
...
our $timeout=10 if !defined $timeout;
######################################################################################################################################################################################################
######################################################################################################################################################################################################
## BUILD PROXIES ARRAY
######################################################################################################################################################################################################
