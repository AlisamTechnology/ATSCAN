...
## SHODAN
our @shodan=('apikey', 'ip', 'count', 'search', 'query', 'querysearch', 'querytags', 'services', 'dnsresolve', 'dnsreverse', 'myip', 'apinfo', 'facets', 'limit', 'pages');
our %shodan=("apikey"=>"Shodan Apikey", "ip"=>"ip or host", "count"=>"shodan count", "search"=>"shiodan search", "query"=>"Shodan saved queries", 
			 ...
			 "limit"=>"Max results limit", "pages"=>"number result pages");
